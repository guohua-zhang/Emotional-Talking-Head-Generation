...
if __name__ == '__main__':
    ...
    loaders_ref = [get_test_loader(os.path.join(dir, 'DECA'), opt) for dir in opt.ref_dirs] if opt.ref_dirs is not None else None
    ...
    ckptio = CheckpointIO(os.path.join(opt.checkpoints_dir, '{}_nets.pth'), opt, len(opt.gpu_ids)>0, **nets)
