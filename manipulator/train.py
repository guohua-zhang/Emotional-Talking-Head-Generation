...
def generate_exp_coeffs(nets, opt, mode='latent'):
    if mode=='latent':
        ...
        opt.ref_dirs = ['celebrities/reference/Nicholson/DECA', 'celebrities/reference/Pacino/DECA', 'celebrities/reference/DeNiro/DECA']
    else:
        raise NotImplementedError
    opt.batch_size = 1
    num_exp_coeffs = 51

    loader_src = get_test_loader('celebrities/test/Pacino/DECA', opt)
