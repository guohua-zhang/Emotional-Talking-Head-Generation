...
for i, data in enumerate(dataset):
    ...
    print('Processing NMFC image', img_path[-1][0])
    ...
    util.save_image(fake_frame, os.path.join(save_dir, img_path[-1][0].split('nmfcs_aligned/')[1]))
